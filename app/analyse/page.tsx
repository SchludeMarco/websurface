      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        <div>
          ...
          <input
            ...
            className="mt-2 block w-full text-sm text-slate-600 file:mr-4 file:rounded-md file:border-0 file:bg-blue-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-blue-700 hover:file:bg-blue-100"
          />
          <button
            type="button"
      ...
      {result && (
        <div className="mt-10 space-y-6">
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-5">
            ...
            <p className="mt-4 text-xs text-blue-800">{result.automatedNotice}</p>
          </div>

          <div className="rounded-lg border border-slate-200 bg-white p-5">
            <h3 className="font-semibold text-slate-900">Berechnete Kennzahlen</h3>
            <dl className="mt-3 grid grid-cols-2 gap-4 text-sm">
              <div>
                <dt className="text-slate-500">Datenzeilen</dt>
                <dd className="font-medium text-slate-900">
                  {result.metrics.rowCount}
                </dd>
              </div>
              <div>
                <dt className="text-slate-500">Gesamtumsatz</dt>
                <dd className="font-medium text-slate-900">
